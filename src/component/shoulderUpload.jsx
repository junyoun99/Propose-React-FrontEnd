...
const ShoulderUpload = () => {  
  ...
  const image1 = [
    imagePath + '0.jpg',
    imagePath +  'images/shoulder_0.jpg'
  ];

  const image2 = [
    imagePath + '1.jpg',
    imagePath +  'images/shoulder_1.jpg'
  ];

  const image3 = [
    imagePath + '2.jpg',
    imagePath +  'images/shoulder_2.jpg'
  ];

  const image4 = [
    imagePath + '3.jpg',
    imagePath +  'images/shoulder_3.jpg'
  ];
  ...
  const save = () => {
    ...
    let add_point = localStorage.getItem('point_shoulder') + ',' + average_point.toString()
      localStorage.setItem('point_shoulder', add_point)
      if(add_point != null){
        axios.post('http://localhost:8080/members/AddPoint', {
                ...
                console.log(res.data.point_shoulder);
            })
      }
      alert("기록이 저장되었습니다.")
  }
            ...
            for(let j = 0; j < data.split('&,')[i].split(',').length; j++){
                ...
                if(leftLeg){
                  if((parseInt(data.split('&,')[i].split(',')[j*2]) === 9) || (parseInt(data.split('&,')[i].split(',')[j*2]) === 11)){
                    ...
                    if(parseInt(data.split('&,')[i].split(',')[j*2+1]) < 0){
                      if(i === 0){
                        comments0 = comments0 + "왼쪽 다리를 더 벌려주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "왼쪽 다리를 더 벌려주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "왼쪽 다리를 더 벌려주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "왼쪽 다리를 더 벌려주세요.\n"
                      }
                    }
                    else{
                      if(i === 0){
                        comments0 = comments0 + "왼쪽 다리를 더 구부려주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "왼쪽 다리를 더 구부려주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "왼쪽 다리를 더 구부려주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "왼쪽 다리를 더 구부려주세요.\n"
                      }
                    }
                  }
                }
