...
const AnkleUpload = () => {  
  ...
  const image1 = [
    imagePath + '0.jpg',
    imagePath +  'images/ankle_0.jpg'
  ];

  const image2 = [
    imagePath + '1.jpg',
    imagePath +  'images/ankle_1.jpg'
  ];

  const image3 = [
    imagePath + '2.jpg',
    imagePath +  'images/ankle_2.jpg'
  ];

  const image4 = [
    imagePath + '3.jpg',
    imagePath +  'images/ankle_3.jpg'
  ];
  ...
  const save = () => {
    ...
    let add_point = localStorage.getItem('point_ankle') + ',' + average_point.toString()
      localStorage.setItem('point_ankle', add_point)
      if(add_point != null){
        axios.post('http://localhost:8080/members/AddPoint', {
                ...
                console.log(res.data.point_ankle);
            })
      }
      alert("기록이 저장되었습니다.")
  }
            ...
            for(let j = 0; j < data.split('&,')[i].split(',').length; j++){
                if(rightArm){
                  if((parseInt(data.split('&,')[i].split(',')[j*2]) === 1) || (parseInt(data.split('&,')[i].split(',')[j*2]) === 3)){
                    ...
                    if(parseInt(data.split('&,')[i].split(',')[j*2+1]) < 0){
                      if(i === 0){
                        comments0 = comments0 + "오른쪽 팔을 올려 몸의 중심을 잡아주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "오른쪽 팔을 더 올려주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "오른쪽 팔을 더 올려주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "오른쪽 팔을 더 올려주세요.\n"
                      }
                    }
                    else{
                      if(i === 0){
                        comments0 = comments0 + "오른쪽 팔을 내려 몸의 중심을 잡아주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "오른쪽 팔을 더 내려주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "오른쪽 팔을 더 내려주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "오른쪽 팔을 더 내려주세요.\n"
                      }
                    }
                  }
                }
                ...
                if(leftArm){
                  if((parseInt(data.split('&,')[i].split(',')[j*2]) === 2) || (parseInt(data.split('&,')[i].split(',')[j*2]) === 4)){
                    ...
                    if(parseInt(data.split('&,')[i].split(',')[j*2+1]) < 0){
                      if(i === 0){
                        comments0 = comments0 + "왼쪽 팔을 올려 몸의 중심을 잡아주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "왼쪽 팔을 더 올려주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "왼쪽 팔을 더 올려주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "왼쪽 팔을 더 올려주세요.\n"
                      }
                    }
                    else{
                      if(i === 0){
                        comments0 = comments0 + "왼쪽 팔을 내려 몸의 중심을 잡아주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "왼쪽 팔을 더 내려주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "왼쪽 팔을 더 내려주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "왼쪽 팔을 더 내려주세요.\n"
                      }
                    }
                  }
                }
                ...
                if(rightLeg){
                  if((parseInt(data.split('&,')[i].split(',')[j*2]) === 8) || (parseInt(data.split('&,')[i].split(',')[j*2]) === 10)){
                    ...
                    if(parseInt(data.split('&,')[i].split(',')[j*2+1]) < 0){
                      if(i === 0){
                        comments0 = comments0 + "오른쪽 다리를 더 올려주세요.(필요하다면 오른손의 도움을 받아도 좋습니다.)\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "오른쪽 다리를 더 올려주세요.(필요하다면 오른손의 도움을 받아도 좋습니다.)\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "오른쪽 다리를 더 올려주세요.(필요하다면 오른손의 도움을 받아도 좋습니다.)\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "오른쪽 다리를 더 올려주세요.(필요하다면 오른손의 도움을 받아도 좋습니다.)\n"
                      }
                    }
                    else{
                      if(i === 0){
                        comments0 = comments0 + "오른쪽 다리를 더 내려주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "오른쪽 다리를 더 내려주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "오른쪽 다리를 더 내려주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "오른쪽 다리를 더 내려주세요.\n"
                      }
                    }
                  }
                }
                ...
                if(leftLeg){
                  if((parseInt(data.split('&,')[i].split(',')[j*2]) === 9) || (parseInt(data.split('&,')[i].split(',')[j*2]) === 11)){
                    ...
                    if(parseInt(data.split('&,')[i].split(',')[j*2+1]) < 0){
                      if(i === 0){
                        comments0 = comments0 + "왼쪽 다리를 몸의 중심 바깥으로 이동해주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "왼쪽 다리를 몸의 중심 바깥으로 이동해주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "왼쪽 다리를 몸의 중심 바깥으로 이동해주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "왼쪽 다리를 몸의 중심 바깥으로 이동해주세요.\n"
                      }
                    }
                    else{
                      if(i === 0){
                        comments0 = comments0 + "왼쪽 다리를 몸의 중심 안쪽으로 이동해주세요.\n"
                      }
                      else if(i === 1){
                        comments1 = comments1 + "왼쪽 다리를 몸의 중심 안쪽으로 이동해주세요.\n"
                      }
                      else if(i === 2){
                        comments2 = comments2 + "왼쪽 다리를 몸의 중심 안쪽으로 이동해주세요.\n"
                      }
                      else if(i === 3){
                        comments3 = comments3 + "왼쪽 다리를 몸의 중심 안쪽으로 이동해주세요.\n"
                      }
                    }
                  }
                }
